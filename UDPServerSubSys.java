 ...
 *
 */
public class UDPServerSubSys extends Subsystem {
    ...
    public void periodic() {
        ...
        if (isRunning()){
            ...
            SmartDashboard.putString("UDP Server Last Rcvd Msg", getLastMessage());
        } else {
...
{ 
    ...
    private String getDgramString(boolean clearIt) {
      String temp ;
      if (clearIt) {
