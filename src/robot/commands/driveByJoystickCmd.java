...
public class driveByJoystickCmd extends Command {
    ...
    private static final int XBOX_LEFT_LOW_GEAR_BTN = 10;
    private static final int XBOX_RIGHT_LOW_GEAR_BTN = 9;
    private static final int XBOX_HIGH_GEAR_BTN = 5;
    ...
    protected void initialize() {
        ...
        if (joy.getAxisCount() > 0) {
            ...
            if (Robot.drivetrain.isXboxModeLeft()) {
                ...
                HIGH_GEAR_BTN = XBOX_HIGH_GEAR_BTN;
    ...
    private void updateDrivetrainGearSetting(){
        ...
        // Check for Manual Low gear mode
        ...
        // Check for Manual High gear mode
        if ((joyType == JoyType.XBOX) && ( ctrlr.getRawButton(HIGH_GEAR_BTN) == true)) {
            // if button is held down disregard velocity and acceleration and just lock in low
