...
import robot.Robot;
import robot.subsystems.ElevSubSys;
import robot.subsystems.ElevSubSys.ElevDir;
...
public class ElevByJoystickCmd extends Command {
    ...
    private static ElevSubSys.ElevDir dir;
    ...
    protected void execute() {
        if (joyCo.getRawButton(1) == false) {
            // Trigger not pushed 
        	Robot.elevSubSys.elevHoldMtr();
    	} else {
    		calcElevMtrSpd();
            Robot.elevSubSys.elevMoveMtr(motorSpeed, dir);
    	}
    }
    ...
    void calcElevMtrSpd(){
        // ------------ Joystick Operation ------------
        // Y axis forward -> -1 Elev Lower    Pull Back -> +1 Raise
        // X Axis Left    -> -1                    right -> +1
        // Twist CCW -> -1      CW -> +1
        // Throttle Forward -> -1     Back -> +1
        //
        ...
        motorSpeed= (yValue * throttle * -1) + ElevSubSys.KHoldSpeed; 
    }
}
